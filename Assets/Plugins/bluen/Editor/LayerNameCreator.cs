...
// https://gist.github.com/baba-s/9286212 ; thanks to author
...
namespace bluen.Editor
{
    ...
    public static class LayerNameCreator
    {
        ...
        private const string ITEM_NAME = "Tools/bluen/Create/Layer Name";    // コマンド名
        ...
        public static void Create()
        {
            ...
            EditorUtility.DisplayDialog(FILENAME, "is generated", "OK");
        }
        ...
        public static void CreateScript()
        {
            ...
            builder.AppendLine("/// layername management as constant value");
            builder.AppendLine("/// </summary>");
